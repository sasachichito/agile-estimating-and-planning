...
export default class extends iteration {
    ...
    createMainTable(scopeId, scopeTitle) {
        ...
        var edit = this.parts.edit(function() {iScopeInstance().editStory(this.closest('.main-entry'))});
        var trash = this.parts.trash(function() {iScopeInstance().deleteScope(this.closest('.main-entry'))});
    ...
    makePutInput(scope) {
        ...
        this.section.inputBlock1().appendChild(
            this.parts.operationBlock(
                function() {iScopeInstance().erase()},
                function() {iScopeInstance().send()},
            )
        );
    }
    ...
    makeIStoryIdList(storyIdList) {
        ...
        var plusButton = this.parts.plusButton(function() {iScopeInstance().addStoryIdInput(this.closest('#storyIdList'), this.closest('div'))});
