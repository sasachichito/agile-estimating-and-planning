...
public class ScopeService {
    ...
    public Map<Story, AdjustedStoryIdealHours> getAdjustedStoryIdealHours(ScopeId scopeId) {
        Scope scope = this.scopeRepository.get(scopeId);
        ...
        return scope.adjustedStoryIdealHours(
                controlRateForStory,
                new AdjustedStoryIdealHoursCalculator(this.storyRepository));
    }
}
