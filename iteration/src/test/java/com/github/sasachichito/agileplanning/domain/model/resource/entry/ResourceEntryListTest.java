        ...
        try {
            new ResourceEntryList(List.of(
                    new ResourceEntry(
                            ...
                            new MemberSet(Set.of(
                                    new Member(new MemberName("A"), new WorkingHoursPerDay(BigDecimal.valueOf(7)), new UnitCostPerHour(BigDecimal.valueOf(15000)))
                            ))),
                    new ResourceEntry(
                            new ResourcePeriod(LocalDate.of(2020, 2, 1), LocalDate.of(2020, 2, 15)),
                            new MemberSet(Set.of(
                                    new Member(new MemberName("B"), new WorkingHoursPerDay(BigDecimal.valueOf(7)), new UnitCostPerHour(BigDecimal.valueOf(15000)))
                            )))
            ));
        } catch (Exception e) {
            fail();
